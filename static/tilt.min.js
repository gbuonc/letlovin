var VanillaTilt = function () {
   ...
   class t {
      ...
      addEventListeners() {
         this.page.addEventListener("mouseenter", this.onMouseEnter.bind(this)), 
      ...
      removeEventListeners() {
         this.page.removeEventListener("mouseenter", this.onMouseEnter.bind(this)), this.page.removeEventListener("mousemove", this.onMouseMove.bind(this)), this.page.removeEventListener("mouseleave", this.onMouseLeave.bind(this)),
      ...
      getValues() {
         if (!this.event.clientX && !this.event.clientY){
            console.log('MOBILE', this.event.beta, this.event.gamma, Math.sin(this.event.beta));
            var t = Math.abs(Math.sin(this.event.gamma/50)),
               e = Math.abs(Math.sin(this.event.beta/50));
         }else{
